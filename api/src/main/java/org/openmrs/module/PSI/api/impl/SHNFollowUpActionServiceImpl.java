...
public class SHNFollowUpActionServiceImpl  extends BaseOpenmrsService implements SHNFollowUpActionService {
	...
	public List<SHNFollowUPReportDTO> getfollowUpReprt(String visitStartDate,
			...
			String moileNo, String patientHid, String clinicCode, String patientName,String defaultLoad) {
		// TODO Auto-generated method stub
		return dao.getfollowUpReprt(visitStartDate, visitEnd, followUpStartDate, followUpEndDate, moileNo, patientHid, clinicCode, patientName,defaultLoad);
	}
