...
<div class="container register-form" style="max-width: 100%;padding: 0px; margin: 0px;">
	<div class="form">
		...
		<form:form id="addServiceCategoryForm" method="POST" action="/module/PSI/addServiceCategory" modelAttribute="serviceCategory">
...
<script type="text/javascript" src="/openmrs/moduleResources/PSI/js/categoryService.js"></script>
